...
const ContactInfo: FC<ContactInfoProps> = ({
  ...
  /**
   *
   * Contact Info Component with the ContactInfoProps interface.
   */
    ...
    <>
      <section className="dark:bg-darkmode pt-8 pb-24">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
          <div className="flex md:flex-row flex-col md:items-start items-center justify-center md:gap-28 gap-8">
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              <div className="bg-heroBg dark:bg-search p-4 flex items-center justify-center rounded-full">
                <i className="bg-[url('/icon/request-demo-icon.svg')] bg-no-repeat bg-contain w-9 h-9 inline-block"></i>
              </div>
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  ...
                  <p className=" text-xl max-w-80 pt-3 pb-7 text-muted dark:text-white dark:text-opacity-70">
                    Discover how our radio systems can support your mission.
                ...
                <div>
                  <button
                    onClick={() => handleDemo()}
                    className="text-primary text-18 leading-normal font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white"
                  >
                    Request Now
                    <svg
                      width="23"
            ...
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              <div className="bg-heroBg dark:bg-search p-4 flex items-center justify-center rounded-full">
                <i className="bg-[url('/icon/email-us-icon.svg')] bg-no-repeat bg-contain w-9 h-9 inline-block"></i>
              </div>
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  <span className="text-midnight_text dark:text-white text-xl font-bold">
                  ...
                  <p className="font-normal text-xl max-w-80 pt-3 pb-7 text-muted dark:text-white dark:text-opacity-70">
                    Have questions or specific requirements? Send us a message
            ...
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              <div className="bg-heroBg dark:bg-search p-4 flex items-center justify-center rounded-full">
                <i className="bg-[url('/icon/career-icon.svg')] bg-no-repeat bg-contain w-9 h-9 inline-block"></i>
              </div>
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  <span className="text-midnight_text dark:text-white text-xl font-bold">
                  ...
                  <p className="font-normal text-xl max-w-80 pt-3 text-muted dark:text-white dark:text-opacity-70">
                    Join our mission to build next-generation communication
                    solutions. Submit your CV today.
                  </p>
                </div>
                <div>
                  <button
                    onClick={() => handleCarrers()}
                    className="text-primary text-18 leading-normal font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white"
                  >
                    Apply Now
                    <svg
