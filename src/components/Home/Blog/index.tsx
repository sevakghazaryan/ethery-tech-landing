      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="flex sm:flex-row flex-col justify-between sm:items-end sm:gap-0 gap-4 mb-16">
          ...
          <div className="">
            <Link
              href="/blog"
              className="text-midnight_text border-2 text-16 font-semibold flex gap-2 px-7 py-3 items-center rounded-full border-midnight_text bg-transparent w-fit hover:bg-midnight_text hover:text-white dark:border-white dark:text-white hover:dark:bg-white hover:dark:text-midnight_text"
            >
              Discover All
