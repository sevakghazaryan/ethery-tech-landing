        ...
        <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4">
              <div className="z-20 mb-16 h-150 overflow-hidden rounded md:h-45">
                <Image
                  src={post.coverImage}
                  alt="image"
                  width={1170}
                  ...
                  <div>
                    <div className="-mx-4 mb-8 flex flex-col">
                      ...
                      <div className="w-full py-12 px-11 bg-white dark:bg-dark_b shadow-lg rounded-b-lg">
                        ...
                        />
                        <button className="bg-primary w-full px-7 border text-base text-white border-primary py-4 rounded hover:bg-transparent hover:text-primary">
                          Subscribe
                        </button>
                      </div>
                    </div>
